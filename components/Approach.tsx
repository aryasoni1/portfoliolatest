  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        ...
        <h2
          className="dark:text-white opacity-0 group-hover/canvas-card:opacity-100 relative z-10 text-black mt-4  font-bold group-hover/canvas-card:text-white group-hover/canvas-card:-translate-y-2 transition duration-200  text-sm text-center "
          style={{ color: "#e4ecff" }}
        >
          {des}
        </h2>
